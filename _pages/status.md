    ...
    <div class="rpg-status-card">
      ...
      <div class="rpg-body">
        ...
        <ul class="rpg-stats-list">
          ...
          <li><span>HP:</span> <strong style="flex: 1; text-align: center;">1200 / 1200</li>
          <li><span>MP（総保有ポイント）:</span> <strong id="total-magic" style="color: #0077cc;">0 Pt</strong></li>
        ...
        <table class="rpg-equipment-table">
          ...
          <tr>
            <th><i class="fas fa-phone" style="color: #00bcd4;"></i> 盾（携帯電話）</th>
    ...
    <div class="rpg-status-card">
      ...
      <div class="rpg-body">
        <ul class="rpg-stats-list">
          ...
          <li><span>総魔力値:</span> <strong style="color: #0077cc;">--</strong> Pt</li>
